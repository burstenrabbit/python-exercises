...
def word_counting(filename):
  ...
  for line in file:
    ...
    for word in splitline:
      ...
      ## remove punctuation from the word and check if word is just punctuation/spaces/numbers
      isaword = False
      ...
      if word in allwords and isaword == True:
        allwords[word] += 1
      elif isaword == True:
        allwords[word] = 1
